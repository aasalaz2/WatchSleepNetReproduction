...
if __name__ == "__main__":
    ...
    """
    root_path = "/content/drive/MyDrive/CS598/WatchSleepNet_project/data"

    logging.info("Starting dataset processing...")
    output_dir      = f"{root_path}/SHHS_MESA_IBI_new"

    shhs_input_dir  = f"{root_path}/SHHS_ECG"
    shhs_info_path  = f"{root_path}/SHHS/datasets/shhs-harmonized-dataset-0.21.0.csv"
    shhs_id_col = "nsrrid"
    ...
    mesa_input_dir  = f"{root_path}/MESA_PPG"
    mesa_info_path  = f"{root_path}/MESA/datasets/mesa-sleep-harmonized-dataset-0.8.0.csv"
    mesa_id_col = "nsrrid"
